...
const GoogleSigninButton: React.FC<GoogleSigninButtonProps> = ({ onClick }) => {
    ...
    return (
        <button
            onClick={onClick}
            className="flex items-center justify-center gap-4 text-black bg-white font-medium text-base py-4 px-0 w-full border border-gray-400 rounded-md hover:bg-black hover:text-white"
        >
            {/* Google Icon SVG */}
            <svg
                width="24"
